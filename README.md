...
ReactDOM.render(
<Sortable onSort={handleSort}>
  <SortableContaienr sortData="1" >
    <div> your item </div>
  </SortableContaienr>
  <SortableContaienr sortData="2">
    <div> your item </div>
  </SortableContaienr>
</Sortable>
, document.body);
...
ReactDOM.render(
<Sortable onSort={handleSort}>
  <SortableContaienr component={<span />} sortableData="1"}>
    <div> your item </div>
  </SortableContaienr>
  <SortableContaienr compoennt={<div />} sortData="2">
    <div> your item </div>
  </SortableContaienr>
</Sortable>
, document.body);
